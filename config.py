...
class CoreConfig:
    ...
    dataset_name: str = "gsm8k" # {"gsm8k", "aime25", "math500", "olympiadbench", "amc23", "minervamath", "math", "aquarat"}
...
def build_parser() -> argparse.ArgumentParser:
    ...
    core.add_argument("--dataset_name", required=True, choices=["gsm8k", "aime25", "math500", "olympiadbench", "amc23", "minervamath", "math", "aquarat"],
